...
static const uint8_t WITMOTION_BLE_COMBINED_FLAG = 0x61; ///< WT901BLECL5.0 combined acceleration/angular velocity/angle packet flag.
static const uint8_t WITMOTION_BLE_REGISTER_FLAG = 0x71; ///< WT901BLECL5.0 register read response packet flag.
...
enum witmotion_packet_id
{
    ...
    pidTemperature = 0x60 ///< Temperature-only synthetic packet emitted from WT901BLECL5.0 register reads.
};
