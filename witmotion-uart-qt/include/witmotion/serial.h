...
private:
    ...
    uint8_t ble_payload[18];
    size_t ble_payload_count;
protected:
    QTextStream ttyout;
    QTimer* poll_timer;
    ...
    void EmitSyntheticPacket(const witmotion_packet_id id, const int16_t cells[4]);
    void ProcessBleCombinedPacket();
    void ProcessBleRegisterPacket();
public:
